...
| `canonical-load` | REVISE (round 4's two P1s **RESOLVED** by maintainer disposition and corrected at review — adoption by opaque locator carrying the snapshot value, paged candidate access, and the spill obligation landed in bootstrap 3.5's own task line. No open finding; awaiting a review round against the resolving commit) | 9 | `f11581d+1` |
