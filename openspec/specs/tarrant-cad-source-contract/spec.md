# tarrant-cad-source-contract Specification

## Purpose
Define the synthetic, adapter-local Tarrant certified-core parser foundation, source-native records, bounded provenance and diagnostics, and atomic release rejection without claiming live-release compatibility or production readiness.
