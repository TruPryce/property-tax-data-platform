# denton-cad-source-contract Specification

## Purpose
Define the shared PACS fixed-width component and the synthetic Denton parser foundation, including owner-row grain, child relationships, source-native records, and bounded diagnostics without claiming live-release compatibility or production readiness.
