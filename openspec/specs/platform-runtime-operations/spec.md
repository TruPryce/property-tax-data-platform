# platform-runtime-operations Specification

## Purpose
Define replaceable local runtime storage and the completed PostgreSQL recovery foundation: segregated durable backup storage, keyless credentials, independent scheduling, and isolated point-in-time restore evidence. Remaining runtime, recovery-gate, and observability work is tracked in the active bootstrap change.
