# ellis-cad-source-contract Specification

## Purpose
Define the synthetic Ellis binding to the shared PACS component, independent layout and release-label gates, owner-row grain, typed materialization, and bounded diagnostics without claiming live-release compatibility or production readiness.
