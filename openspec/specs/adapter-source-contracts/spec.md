# adapter-source-contracts Specification

## Purpose
Define shared immutable adapter-local source values, provenance, and appraisal records while preserving county-specific identifiers, source-native semantics, and the documented privacy boundary.
